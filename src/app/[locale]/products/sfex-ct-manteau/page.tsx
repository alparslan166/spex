...
export default function SfexCTManteauPage() {
  const t = useTranslations("ProductDetails.sfex-ct-manteau");
  ...
  const specifications = [
    ...
    {
      title: t("specifications.3.title"),
      items: [
        { label: t("specifications.3.items.0.label"), value: t("specifications.3.items.0.value") },
        { label: t("specifications.3.items.1.label"), value: t("specifications.3.items.1.value") },
        { label: t("specifications.3.items.2.label"), value: t("specifications.3.items.2.value") },
        { label: t("specifications.3.items.3.label"), value: t("specifications.3.items.3.value") },
        { label: t("specifications.3.items.4.label"), value: t("specifications.3.items.4.value") },
      ],
    },
  ];
  ...
  return (
    <ProductPageTemplate
      productName={t("name")}
      subtitle={t("subtitle")}
      videoUrl="https://www.youtube.com/embed/5pwwAsl6rcc?si=pNxH7emtWW_LXI_B"
      overview={overview}
      features={features}

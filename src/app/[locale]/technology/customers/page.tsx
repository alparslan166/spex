...
export default function CustomersPage() {
  ...
  const displayedLogoCustomers = showAllLogos
    ? logoCustomers
    : logoCustomers.slice(0, 40);
  const displayedTextCustomers = showAllText
    ? textCustomers
    : textCustomers.slice(0, 40);

  return (
    <SubPageLayout title={t("techTitle")} sideNav={sideNav}>
